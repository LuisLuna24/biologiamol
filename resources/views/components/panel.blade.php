...
<body class="font-sans antialiased">
                    ...
                    <div class="relative mt-2 block" x-data="{ open: false }" @click.away="open = false"
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <ul class="py-1" role="none">
                                ...
                                @if (Auth::user()->nivel_usuario == 1 || Auth::user()->nivel_usuario == 2)
                                    <li>
                                        <a @switch(Auth::user()->nivel_usuario)
                                            @case(1)
    ...
    <aside id="aside" style="transition: width 0.5s, transform 0.5s; "
        class="z-20 fixed top-0 left-0 w-[250px] h-screen bg-white pb-5 pl-[15px] pr-[15px] -translate-x-full overflow-hidden  contenedor  md:translate-x-0 md:hover:w-[250px]  dark:bg-gray-800">

        {{-- Title page --}}
        <div class="aside_section-title bg-white dark:bg-gray-800 md:hidden">
            <img src="{{ asset('images/G_Logo.png') }}" alt="" class="list_image">
        </div>
        <div class="aside_section-title bg-white dark:bg-gray-800 max-md:hidden">
            <img id="logo_gisena" src="{{ asset('images/Gisena_Logo.png') }}" alt="" class="h-12">
        </div>

        {{-- user type  --}}
        <div class="aside_section mt-4">
            <img src="{{ asset('images/user.svg') }}" alt="" class="h-12">
            <div class="flex flex-col">
                <span class="text-sm ml-[16px] font-semibold dark:text-slate-100">
                    @if (Auth::check())
                        @switch(Auth::user()->nivel_usuario)
                            {{-- 52 characters --}}
                            @case(1)
            ...
            <nav class="mt-10">
                ...
                @else
                    ...
                    {{--  --}} @endif
                            ...
                            <span class="list_span">Panel</span>
                        </a>
                    </li>
                            ...
                            @case(1)
                                ...
                                <li class="mt-3 link">
                                    <div
                                        ...
                                        <img src="{{ asset('images/registro.svg') }}" alt="" class="min-w-[50px] h-8 dark:stroke-white">
                                        <span class="list_span">Inventarios</span>
                                        <img src="{{ asset('images/arrow.svg') }}" alt="" class="list_arrow h-8 ml-auto ">
                                    </div>
                                ...
                                <li class="mt-3 link">
                                    <div
                                        ...
                                        <img src="{{ asset('images/bitacoras.svg') }}" alt="" class="list_image">
    ...
    <div id="home" class="pt-[58px]  min-h-screen md:ml-[250px] bg-gray-100 dark:bg-gray-900 flex flex-col"
        ...
        <div
            ...
            <h2 class="ml-auto pr-5 dark:text-gray-200">Version 1.0.0</h2>
        </div>
    </div>
            ...
            public() {
                ...
                if (ancho < 768) {
                    ...
                    if (this.open) {
                        ...
                        this.open = !this.open;
                        var imagen = document.getElementById("logo_gisena");
                        imagen.src = "{{ asset('images/Gisena_Logo.png') }}";
                        ...
                        this.open = !this.open;
                        var imagen = document.getElementById("logo_gisena");
                        imagen.src = "{{ asset('images/G_Logo.png') }}";
                    }
                }
            },
            method_a() {
